...
public class AkSoundEngine {
  ...
  public static void ListenToAudioSessionInterruption(bool in_bEnterInterruption) {
    AkSoundEnginePINVOKE.CSharp_ListenToAudioSessionInterruption(in_bEnterInterruption);
